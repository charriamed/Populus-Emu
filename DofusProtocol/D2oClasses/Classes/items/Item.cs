...
namespace Stump.DofusProtocol.D2oClasses
{
    ...
    public class Item : IDataObject, IIndexedData
    {
        ...
        public List<uint> DropTemporisMonsterIds
        {
            get { return this.dropTemporisMonsterIds; }
            set { this.dropTemporisMonsterIds = value; }
        }
        [D2OIgnore]
        public uint RecipeSlots
        {
        ...
        public Boolean ObjectIsDisplayOnWeb
        {
            get { return this.objectIsDisplayOnWeb; }
            set { this.objectIsDisplayOnWeb = value; }
        }
        [D2OIgnore]
        public Boolean BonusIsSecret
        {
        ...
        public List<uint> EvolutiveEffectIds
        {
            get { return this.evolutiveEffectIds; }
            set { this.evolutiveEffectIds = value; }
        }
        [D2OIgnore]
        public List<uint> FavoriteSubAreas
        {
        ...
        public String CraftVisible
        {
            get { return this.craftVisible; }
            set { this.craftVisible = value; }
        }
        [D2OIgnore]
        public String CraftFeasible
        {
            get { return this.craftFeasible; }
            set { this.craftFeasible = value; }
        }
        [D2OIgnore]
        public Boolean NeedUseConfirm
        {
        ...
        public Boolean IsSaleable
        {
            get { return this.isSaleable; }
            set { this.isSaleable = value; }
        }
        [D2OIgnore]
        public List<List<double>> NuggetsBySubarea
        {
