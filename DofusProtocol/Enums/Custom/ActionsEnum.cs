namespace Stump.DofusProtocol.Enums {
    ...
    ActionsEnum {
        ...
        ACTION_CHARACTER_PLAY_SPELL_ANIMATION = 237,
        ...
        ACTION_CHARACTER_REMOVE_ALL_SPELL_EFFECTS = 406,
        ...
        ACTION_DEBOOST_PUSH_DMG_REDUCTION = 417,
        ...
        ACTION_CHARACTER_JOB_REFERENCEMENT = 699,
        ...
        ACTION_CHARACTER_CHATIMENT = 788,
        ...
        ACTION_SHOW_ALIGNMENT = 960,

        ACTION_SHOW_GRADE = 961,

        ACTION_SHOW_LEVEL = 962,

        ACTION_CREATED_SINCE = 963,

        ACTION_SHOW_PLAYERNAME = 964,

        ACTION_LIVING_OBJECT_ID = 970,

        ACTION_LIVING_OBJECT_MOOD = 971,

        ACTION_LIVING_OBJECT_SKIN = 972,

        ACTION_LIVING_OBJECT_CATEGORY = 973,

        ACTION_LIVING_OBJECT_LEVEL = 974,

        ACTION_LINKED_TO_CHARACTER = 981,

        ACTION_LINKED_TO_ACCOUNT = 982,

        ACTION_LINKED_UNTIL_DATE = 983,

        ACTION_NAME_MAGE = 985,

        ACTION_NAME_OWNER = 987,

        ACTION_NAME_CRAFTER = 988,

        ACTION_MOUNT_DESCRIPTION = 995,

        ACTION_MOUNT_DESCRIPTION_OWNER = 996,

        ACTION_MOUNT_DESCRIPTION_WITH_DATE = 998,

        ACTION_PET_REDUCE_MAX_BONUS = 1005,

        ACTION_PET_REDUCE_MIN_BONUS = 1006,
        ...
        ACTION_CHARACTER_ADD_RANDOM_ILLUSION = 1024,
        ...
        ACTION_CHARACTER_BOOST_VITALITY_PERCENT = 1078,

        ACTION_CHARACTER_DEBOOST_VITALITY_PERCENT = 1033,

        ACTION_CHARACTER_GET_PUSHED = 1041,

        ACTION_CHARACTER_GET_PULLED = 1042,

        ACTION_CHARACTER_IMMUNITY_AGAINST_SPELL = 1044,
        ...
        ACTION_CHARACTER_GAIN_JOB_LEVEL = 1050,

        ACTION_BOOST_SPELL_DAMAGES_PERCENT = 1054,

        ACTION_SHARE_DAMAGES = 1061,
        ...
        ACTION_BOOST_ITEM_WEIGHT = 1081,

        ACTION_ITEM_GIFT_CONTENT = 1084,

        ACTION_PLACE_GLYPH_AURA = 1091,

        ACTION_CHARACTER_ADD_MIRROR_ILLUSION = 1097,

        ACTION_TELEPORT_TO_TURN_START_POSITION = 1099,

        ACTION_TELEPORT_TO_PREVIOUS_POSITION = 1100,

        ACTION_SPEAKING_OBJECT = 1102,

        ACTION_TELEPORT_MIRROR_BY_TARGET = 1104,

        ACTION_TELEPORT_MIRROR_BY_CASTER = 1105,

        ACTION_TELEPORT_MIRROR_BY_AREA_CENTER = 1106,

        ACTION_GAIN_LIFE_ON_TARGET_LIFE_PERCENT = 1109,

        ACTION_ITEM_LOOT_COUNT = 1111,

        ACTION_FIGHT_BOOST_WEAPON_DAMAGE_POWER = 1144,

        ACTION_ITEM_SKIN_ITEM = 1151,

        ACTION_CHARACTER_MULTIPLY_RECEIVED_HEAL = 1159,

        ACTION_CASTER_EXECUTE_SPELL = 1160,

        ACTION_CHARACTER_COMPANION = 1161,

        ACTION_CHARACTER_MULTIPLY_RECEIVED_DAMAGE = 1163,

        ACTION_CHARACTER_GIVE_LIFE_WITH_RATIO = 1164,

        ACTION_BOOST_FINAL_DAMAGES_PERCENT = 1171,

        ACTION_DEBOOST_FINAL_DAMAGES_PERCENT = 1172,

        ACTION_CAST_SPELL_AT_FIGHT_START = 1175,

        ACTION_WRAPPER_OBJECT_GID = 1176,

        ACTION_WRAPPER_OBJECT_CATEGORY = 1179,

        ACTION_FIGHT_DISABLE_PORTAL = 1183,

        ACTION_MOUNT_HARNESS_GID = 1187,

        ACTION_MOUNT_ADD_CAPACITY = 1188,

        ACTION_ITEM_NUGGETS_SHARING = 2021,

        ACTION_LAUNCH_FINISH_MOVE = 2029,

        ACTION_TARGET_CAST_SPELL_ON_TARGETED_CELL = 2794,
        ...
        ACTION_EVOLVING_IMPROVEMENT_POINTS = 2818,

        ACTION_EVOLVING_EXPERIENCE_POINTS = 2819,

        ACTION_ITEM_GIVEN_EXPERIENCE_AS_SUPERFOOD = 2820,

        ACTION_EVOLVING_LEVEL = 2821,

        ACTION_PREVENT_FUTURE_SMITHMAGIC = 2825,

        ACTION_SMITHMAGIC_FORCE_PROBABILITY = 2827,
