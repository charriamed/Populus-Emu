...
namespace Stump.Server.AuthServer.IPC
{
    public class IPCOperations
    {
        ...
        void Handle(TokenMessage message)
        {
            var Token = Managers.AccountManager.Instance.FindAccountByLogin(message.Login);
            Token.Tokens = message.Token;
