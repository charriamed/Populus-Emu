...
//{
//    [Discriminator("Kardorim", typeof(NpcReply), new Type[] { typeof(NpcReplyRecord) })]
//    [Discriminator("Kardorim", typeof(NpcReply), new Type[] { typeof(NpcReplyRecord) })]
//    public class Kardorim : NpcReply
//    {
...
//        public Kardorim(NpcReplyRecord record)
//            : base(record)
//        {
//        }
...
//            else
//            {
//                var item = ItemManager.Instance.CreatePlayerItem(character, ItemId, (int)Amount);
