...
{
    public class SubscribeZoneCriterion : Criterion
    {
        ...
        public override void Build()
        {
            ...
            if (!int.TryParse(Literal, out state))
                throw new Exception(string.Format("Cannot build SubscribeZoneCriterion, {0} is not a valid subscription state (1 or 0)", Literal));
