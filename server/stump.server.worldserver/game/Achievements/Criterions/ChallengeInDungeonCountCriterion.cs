...
{
    public class ChallengeInDungeonCountCriterion : AbstractCriterion<ChallengeInDungeonCountCriterion, DefaultCriterionData>
    {
        // FIELDS
        ...
        {
            return this.Number < character.ChallengesInDungeonCount;
        }

        public override bool Lower(AbstractCriterion left)
        {
            return this.Number < ((ChallengeInDungeonCountCriterion)left).Number;
        }
        ...
        {
            return (ushort)Math.Min(this.MaxValue, player.Owner.ChallengesInDungeonCount);
        }
    }
}
