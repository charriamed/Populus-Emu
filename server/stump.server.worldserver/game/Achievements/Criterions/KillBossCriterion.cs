...
{
    public class KillBossCriterion :
        AbstractCriterion<KillBossCriterion, DefaultCriterionData>
    {
        // FIELDS
        public const string Identifier = "EM";
        private ushort? m_maxValue;

        // CONSTRUCTORS
        public KillBossCriterion(AchievementObjectiveRecord objective)
            : base(objective)
        {
        ...
        {
            return Number < ((KillBossCriterion)left).Number;
        }
