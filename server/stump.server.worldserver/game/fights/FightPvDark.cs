...
{
    public class FightPvDark : Fight<FightMonsterTeam, FightPlayerTeam>
    {
        ...
        public FightPvDark(int id, Map fightMap, FightMonsterTeam defendersTeam, FightPlayerTeam challengersTeam)
            ...
            if (Winners.Fighters.Contains(BreedFighter))
            {
                ...
                if (dopple != null)
                {
                                        ...
                                        !Leavers.Contains(fightPlayerResult.Fighter)))
                    {
                        ...
                        fightPlayerResult.Loot.AddItem(793, _doplon[(byte)doppleGrade.Level]);
                    }
                }
            }
            return list;
